...
public:
	...
	//----------------------------------------
	//êîýôôèöèåíòû ÏÈ-ðåãóëÿòîð ëèíåéíûõ êîíòóðîâ
	//----------------------------------------
	...
	//----------------------------------------
	//êîýôôèöèåíòû ÏÈ-ðåãóëÿòîðà óãëîâûõ êîíòóðîâ
	//----------------------------------------
	...
	//----------------------------------------
	PROP_PARAM(Float, i_ang_max, 1.0f);   // îãðàíè÷åíèå èíòåãðàëà (ðàä)
...
private:
	...
	// èíòåãðàë ïî óãëàì: x=yaw, y=pitch, z=roll (ïðîñòî äîãîâîðèìñÿ òàê)
	...
	float dbg_timer = 0.0f;   // äëÿ ðåäêîãî âûâîäà
